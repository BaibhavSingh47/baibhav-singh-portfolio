    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-[#050816]/75 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
        ...
        >
          ...
          <span>
            <strong className="block text-white">Baibhav Singh</strong>
            <small className="text-violet-300">Full Stack Developer</small>
          </span>
        </a>
        ...
        <button
          className="md:hidden rounded-xl border border-white/10 p-2 text-white"
